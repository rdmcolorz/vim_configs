" Vim color file - taylor
" Generated by http://bytefluent.com/vivify 2017-12-20
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Special guifg=#d168d1 guibg=NONE guisp=NONE gui=NONE ctermfg=170 ctermbg=NONE cterm=NONE
...
hi Statement guifg=#e3c652 guibg=NONE guisp=NONE gui=bold ctermfg=179 ctermbg=NONE cterm=bold
...
hi Number guifg=#39addb guibg=NONE guisp=NONE gui=NONE ctermfg=74 ctermbg=NONE cterm=NONE
...
hi Type guifg=#fad89e guibg=NONE guisp=NONE gui=bold ctermfg=223 ctermbg=NONE cterm=bold
...
hi String guifg=#98bd60 guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE
